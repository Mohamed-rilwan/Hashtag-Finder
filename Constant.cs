...
namespace HashtagFinder
{
    public class Constant
    {
        public static Tuple<string[], string[], string[], string[], int> Values()
        {
            ...
            string[] AnimalHashtagArray = { "#animal", "#animalphotography", "#animalsoginstagram", "#animalwatching", "#animalsogprey", "#nature", "#wildlife", "#wanderrex", "#naturephotography", "#wildlifephotography", "#bestanimalshots", "#animal_captures", "#animalplanet", "#animallife", "#animal_watchers_daily", "#wildlifeplanet", "#pileatedwoodpecker", "#woodpecker", "#seattle" };
